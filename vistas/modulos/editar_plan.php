<?php
$planes = ControladorPlanes::ctrMostrarPlanes("id_plan", $_GET["id"]);
        ...
        <div class="card-body">
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nombre_plan" value="<?php echo $planes["nombre_plan"]; ?>" required>
                </div>
                <div class="form-group">
                    <label for="descripcion_plan">Descripción</label>
                    <textarea class="form-control" name="descrip_plan" rows="3"required><?php echo $planes["descrip_plan"]; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="cod_plan">Código del plan</label>
                    <input type="number" class="form-control" name="cod_plan" value="<?php echo $planes["cod_plan"]; ?>" required>
                </div>
                <div class="form-group">
                    <label for="duracion_plan">Duración (en semanas)</label>
                    <input type="number" class="form-control" name="duracion_plan"  value="<?php echo $planes["duracion_plan"]; ?>" required>
                </div>
                <div class="form-group">
                    <label for="sesiones_semanales_plan">Sesiones semanales</label>
                    <input type="number" class="form-control" name="sesiones_semanales_plan" value="<?php echo $planes["sesiones_semanales_plan"]; ?>" required>
                </div>
                <div class="mb-3">
